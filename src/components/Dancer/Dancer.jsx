...
//         `${API_URL}/api/dancers?filters[Payment][$eq]=Paid&populate=*`,
//         { headers }
//       );
...
//         {loading ? (
//           <div style={{ color: 'white', textAlign: 'center', padding: '20px' }}>Loading dancers...</div>
//         ) : error ? (
  ...
  const getAllSingers = async () => {
    try {
      const [singersRes, agentSingersRes] = await Promise.all([
        axios.get(`${API_URL}/api/dancers?filters[Payment][$eq]=Paid&populate=*&pagination[pageSize]=100`),
        axios.get(`${API_URL}/api/agent-dancers?filters[Payment][$eq]=Paid&populate=*&pagination[pageSize]=100`)
      ]);
      ...
      <Container>
        ...
        {noData ? (
          <div style={{ textAlign: 'center', padding: '50px', color: '#fff' }}>
            <p>No dancers available at the moment.</p>
          </div>
        ) : (
          <>
            <Content1>
