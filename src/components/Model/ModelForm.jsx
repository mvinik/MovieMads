...
console.log('finalPrice:', finalPrice);
  ...
  const handleUpload = async () => {
    ...
    videoFormData.append('refId', localStorage.getItem("ModelId"))
    videoFormData.append('ref', 'api::model.model')
  ...
  return (
    <>
      ...
      <div className="container">
        <div>
          <h1 className='contest-heading'>Model form <p style={{ fontSize: '1.5rem', padding: '0', margin: '0' }}>(Entry fee of <p className='strikeOut'>Rs.999</p> Now Rs.{discount > 0 ? (<>{finalPrice}</>) : (<>{price}</>)} only)</p> </h1>
        </div>
        {/* <div>
  <h1 className="contest-heading">Model Form
    ...
    {discount > 0 ? (
      ...
      <h1 className='contest-heading'>Model form
         <p style={{fontSize:'1.5rem', padding:'0',margin:'0'}}>
          (Entry fee of <p className='strikeOut'>Rs.999</p> Now Rs.{price} only)</p> </h1>
      </div> */}
                          ...
                          >
                            <Upload
                              ...
                              beforeUpload={(file) => {
                                ...
                                if (file.size > MAX_FILE_SIZE) {
                                  message.error('Reel size exceeds the limit of 200MB.');
                                  return Upload.LIST_IGNORE;
                                }

                                const isMp4 = file.type === 'video/mp4';
                                if (!isMp4) {
                                  message.error('Only MP4 format is allowed for reels.');
                                  return Upload.LIST_IGNORE;
                                }
