...
const ModelSlider = () => {
    ...
    const applyNow = async (type, isAgent = false) => {
        if (!token) {
        ...
        if (isAgent) {
            switch(type) {
                case 'Model':
                    ...
                    break;
                case 'Dancer':
                    navigate("/agentDancerForm");
                    break;
                case 'Singer':
                    navigate("/agentSingerForm");
                    break;
                case 'Musician':
                    navigate("/agentMusicianForm");
                    break;
                default:
                    navigate("/agentModelForm");
            }
                ...
                <Info>
                    ...
                    <ButtonContainer>
                        ...
                        <SecondRow>
                            ...
                            >
                                <Button2>
                                    <FormOutlined /> Apply As Agent <DownOutlined />
                                </Button2>
                                {showAgentDropdown && (
                                    <AgentDropdown>
                                        <DropdownItem onClick={() => applyNow('Model', true)}>Agent Model</DropdownItem>
                                          <DropdownItem onClick={() => applyNow('Singer', true)}>Agent Singer</DropdownItem>
                                        <DropdownItem onClick={() => applyNow('Dancer', true)}>Agent Dancer</DropdownItem>
 <DropdownItem onClick={() => applyNow('Musician', true)}>Agent Musician</DropdownItem>
                                    </AgentDropdown>
                                )}
                            </AgentButtonWrapper>
                        </SecondRow>
...
const AgentButtonWrapper = styled.div`
    position: relative;
...
const DropdownItem = styled.div`
    ...
    @media (max-width: 768px) {
        ...
        font-size: 9px;    /* Added font size reduction */
    }
`;
