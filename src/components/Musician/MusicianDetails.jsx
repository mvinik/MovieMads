 ...
 setSelectedVideoIndex(index);
  ...
  const fetchData = async () => {
    try {
      ...
      console.log(details,'musician details');                          
  ...
  const handleSubmit = async () => {
    try {
      ...
      message.success('Musician Request submitted successfully!');
      setModalVisible1(false);
      form.resetFields();
    } catch (error) {
      console.error(error);
      message.error('Failed to submit the musician request!');
    }
          ...
          <>
            ...
            <DetailsContainer>
              ...
              <Look style={{ margin: "10px 0" }}>
                ...
                {details?.attributes?.FormalTraning}
              </Look>
                <Look style={{ margin: "10px 0" }}>
                <span>
              ...
              <Look1><span> <StarOutlined /> Musician_ID:{" "}</span>{details?.attributes?.Musician_ID || "Musician ID Does Not Exists"}</Look1>
              {/* </div> */}
                  ...
                  {details?.attributes?.VideoFile?.data?.map((musician) => (
                    <div key={musician.id}
                      ...
                      //  style={{ height: '100%', width: '100%' }}
                        ...
                        className="MusicianImage" controls autoPlay  loop>
                    <source src={`${API_URL}${musician?.attributes?.url}`} type="video/mp4" />
                    Your browser does not support the video tag.
                  </video>
                    </div>
