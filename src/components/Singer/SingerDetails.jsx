 ...
 setSelectedVideoIndex(index);
  ...
  const fetchData = async () => {
    try {
      ...
      console.log(details,'singer details');                          
  ...
  const handleSubmit = async () => {
    try {
      ...
      message.success('Singer Request submitted successfully!');
      setModalVisible1(false);
      form.resetFields();
    } catch (error) {
      console.error(error);
      message.error('Failed to submit the singer request!');
    }
        ...
        {loading ? (
          ...
          <>
            ...
            <DetailsContainer>
              ...
              <Look1><span> <StarOutlined /> Singer_ID:{" "}</span>{details?.attributes?.Singer_ID || "Singer ID Does Not Exists"}</Look1>
              {/* </div> */}
